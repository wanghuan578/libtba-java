...
public class TbaRsaUtils {
    ...
    public static String signature(byte[] data, String privateKey) throws Exception {
        ...
        return TbaBase64Utils.encode(signature.sign());
    }
    ...
    public static boolean verify(byte[] data, String publicKey, String sign)
            throws Exception {
        byte[] keyBytes = TbaBase64Utils.decode(publicKey);
        ...
        signature.update(data);
        return signature.verify(TbaBase64Utils.decode(sign));
    }
    ...
    public static String getPrivateKey(Map<String, Object> keyMap)
        ...
        return TbaBase64Utils.encode(key.getEncoded());
    }
